...
trainset = DatasetFromFolder("E:/python/shendu/second/tuxiangchaofeng/bsds500/trainval", zoom_factor)
testset = DatasetFromFolder("E:/python/shendu/second/tuxiangchaofeng/bsds500/test", zoom_factor)
...
for epoch in range(nb_epochs):
    ...
    # Save model
    torch.save(model, f"E:/python/shendu/second/tuxiangchaofeng/save_model/model_{epoch}.pth")